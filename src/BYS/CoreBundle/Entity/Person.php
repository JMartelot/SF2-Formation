...
class Person
{
     ...
     * Add group
     *
     * @param \BYS\CoreBundle\Entity\Membership $group
     *
     * @return Person
     */
    public function addGroup(\BYS\CoreBundle\Entity\Membership $group)
    {
        $this->groups[] = $group;
     ...
     * @param \BYS\CoreBundle\Entity\Membership $group
     */
    public function removeGroup(\BYS\CoreBundle\Entity\Membership $group)
    {
