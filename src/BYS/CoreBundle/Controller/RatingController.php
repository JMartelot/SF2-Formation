...
use BYS\CoreBundle\Entity\Rating;
...
class RatingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ratings = $em->getRepository('BYSCoreBundle:Rating')->findAll();
    ...
    {
        $rating = new Rating();
        $form = $this->createForm('BYS\CoreBundle\Form\RatingType', $rating);
    ...
    {
        $deleteForm = $this->createDeleteForm($rating);
        $editForm = $this->createForm('BYS\CoreBundle\Form\RatingType', $rating);
