...
use BYS\CoreBundle\Entity\Proposal;
...
class ProposalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $proposals = $em->getRepository('BYSCoreBundle:Proposal')->findAll();

        return $this->render('proposal/index.html.twig', array(
            'proposals' => $proposals,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BYS\CoreBundle\Form\ProposalType', $proposal);
    ...
    {
        $deleteForm = $this->createDeleteForm($proposal);
        $editForm = $this->createForm('BYS\CoreBundle\Form\ProposalType', $proposal);
