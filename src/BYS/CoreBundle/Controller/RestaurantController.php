...
class RestaurantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $restaurants = $em->getRepository('BYSCoreBundle:Restaurant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BYS\CoreBundle\Form\RestaurantType', $restaurant);
    ...
    {
        $deleteForm = $this->createDeleteForm($restaurant);
        $editForm = $this->createForm('BYS\CoreBundle\Form\RestaurantType', $restaurant);
