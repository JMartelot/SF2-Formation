...
class UserGroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $userGroups = $em->getRepository('BYSCoreBundle:UserGroup')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BYS\CoreBundle\Form\UserGroupType', $userGroup);
    ...
    {
        $deleteForm = $this->createDeleteForm($userGroup);
        $editForm = $this->createForm('BYS\CoreBundle\Form\UserGroupType', $userGroup);
